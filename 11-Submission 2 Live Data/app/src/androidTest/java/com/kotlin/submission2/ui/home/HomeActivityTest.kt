...
class HomeActivityTest {
    ...
    fun loadDetailMovies() {
        ...
        onView(withId(R.id.tv_director)).check(matches(withText("Director : ${dummyMovies[0].directorOrCreator}")))
        ...
        onView(withId(R.id.tv_metascore)).check(matches(isDisplayed()))
        onView(withId(R.id.tv_metascore)).check(matches(withText(metascoreMovies.toString())))
        onView(withId(R.id.tv_reviews)).check(matches(isDisplayed()))
    ...
    fun loadDetailTvSeries() {
        ...
        onView(withId(R.id.tv_director)).check(matches(isDisplayed()))
        onView(withId(R.id.tv_director)).check(matches(withText("Director : ${dummyTvSeries[0].directorOrCreator}")))
        onView(withId(R.id.tv_stars)).check(matches(isDisplayed()))
        onView(withId(R.id.tv_stars)).check(matches(withText("Stars : ${dummyTvSeries[0].stars}")))
        onView(withId(R.id.tv_metascore)).check(matches(isDisplayed()))
        onView(withId(R.id.tv_metascore)).check(matches(withText(metascoreTvSeries.toString())))
        onView(withId(R.id.tv_reviews)).check(matches(isDisplayed()))
