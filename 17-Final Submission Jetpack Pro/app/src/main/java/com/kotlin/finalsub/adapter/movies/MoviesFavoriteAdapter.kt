...
class MoviesFavoriteAdapter(
    ...
    private val callback: ItemsMoviesCallback
) :
    PagedListAdapter<MoviesEntity, MoviesFavoriteAdapter.MoviesViewHolder>(DIFF_CALLBACK) {
    ...
    inner class MoviesViewHolder(val binding: RecyclerItemGridBinding) :
